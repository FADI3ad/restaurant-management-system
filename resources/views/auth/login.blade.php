        ...
        <form method="POST" action="{{ route('login.store') }} " class="auth-form">
            ...
            <div class="field"><label class="field-label" for="email">Email</label>
                <div class="input-icon">
                    ...
                    <input name="email" id="email" class="input" type="" placeholder="you@company.com"
            ...
            <label class="check"><input name="remember" type="checkbox" checked="checked"> <span
                    class="box"></span>تذكرني لمدة 30
                يوماً</label>

            <button class="btn btn--primary auth-submit" type="submit">تسجيل الدخول <svg viewBox="0 0 24 24">
