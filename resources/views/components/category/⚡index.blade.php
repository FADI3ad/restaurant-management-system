    ...
    <div class="smart-filter-bar">
        <div class="filter-search">
            <div class="input-icon">
                ...
                <input type="text" class="input" placeholder="ابحث عن صنف رئيسي..."
                    wire:model.live.debounce.300ms="search" />
            </div>
        </div>
        <div class="filter-actions">
            <select class="select filter-select" wire:model.live="sectionFilter">
            ...
            <button type="button" class="btn btn-filter" wire:click="$reset('search', 'statusFilter', 'sectionFilter')">
