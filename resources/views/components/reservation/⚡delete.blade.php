...
new class extends Component {
    ...
    #[On('confirm-reservation-delete')]
    public function getReservationForDeletion($id)
    {
        $this->reservation = Reservation::findOrFail($id);
    }

    public function delete(DeleteReservationAction $deleteReservation)
    {
...
<div id="modal-delete" class="modal-overlay is-active" x-show="deleteOpen" x-cloak @click.self="deleteOpen = false"
    ...
    <div class="modal-content modal-sm">
        <x-modal-head-component title="تأكيد حذف الحجز" />
            ...
            <div class="modal-body modal-form-stack">
                <div style="text-align: center; padding: 10px 0;">
                    ...
                    <p style="margin: 0; color: var(--t-light); font-size: 14px; line-height: 1.5;">
                        سيتم حذف حجز العميل <strong style="color: var(--t-base);">"{{ $this->reservation?->customer_name }}"</strong>
