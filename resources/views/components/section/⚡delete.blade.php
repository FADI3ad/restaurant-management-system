    ...
    @if ($this->section)
        <div id="modal-delete" class="modal-overlay">
            <div class="modal-content modal-sm">
                ...
                <form wire:submit.prevent="delete" onsubmit="closeModal('modal-delete')">
                    <div class="modal-body modal-form-stack">
                        <div style="text-align: center; padding: 10px 0;">
                            ...
                            <h4 style="margin: 0 0 8px; color: var(--t-base); font-size: 16px; font-weight: 700;">هل أنت متأكد من حذف القسم؟</h4>
                            <p style="margin: 0; color: var(--t-light); font-size: 14px; line-height: 1.5;">
                                سيتم حذف القسم <strong style="color: var(--t-base);">"{{ $this->section->name }}"</strong> نهائياً. جميع الوجبات والفئات التابعة له قد تتأثر. هذا الإجراء لا يمكن التراجع عنه!
                            </p>
                        </div>
                    </div>
                    <div class="modal-foot">
                        <button type="button" class="btn btn--ghost" onclick="closeModal('modal-delete')">إلغاء</button>
