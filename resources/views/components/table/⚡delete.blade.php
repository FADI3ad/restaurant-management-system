...
new class extends Component {
    ...
    #[On('confirm-table-delete')]
    public function getTableForDeletion($id)
    {
        $this->table = Table::findOrFail($id);
    }

    public function delete(DeleteTableAction $deleteTable)
    {
        if ($this->table) {
...
<div id="modal-delete" class="modal-overlay is-active" x-show="deleteOpen" x-cloak @click.self="deleteOpen = false"
    ...
    <div class="modal-content modal-sm">
        <x-modal-head-component title="تأكيد حذف الطاولة" />
