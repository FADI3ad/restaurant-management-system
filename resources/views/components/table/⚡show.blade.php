    ...
    <div class="modal-content modal-md">
        ...
        <div class="modal-body">
            @if ($this->table)
                ...
                <div style="text-align: center; padding: 8px 0 20px;">
                    <div style="background: var(--primary-soft); color: var(--primary); width: 72px; height: 72px; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 12px;">
                ...
                <div class="show-details-grid">
                    ...
                    <div class="show-detail-item">
                        ...
                        <div class="show-detail-value">{{ $this->table->type === 'Private' ? 'خاص (Private)' : 'عام (Public)' }}</div>
                    </div>
                    ...
                    <div class="show-detail-item">
                        ...
                        <div class="show-detail-value">{{ $this->table->min_capacity }} – {{ $this->table->max_capacity }} أشخاص</div>
                    </div>
        ...
        <div class="modal-foot">
            ...
            <button type="button" class="btn btn--primary"
                ...
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:15px;height:15px;margin-inline-end:6px;">
                    <path d="M12 20h9" />
