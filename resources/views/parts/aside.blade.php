<aside class="d-sidebar">
    <div class="brand">
        <div class="brand-logo">
            @if (setting('restaurant_logo'))
                <img src="{{ setting('restaurant_logo') }}" alt="{{ setting('restaurant_name', 'مطعمنا') }}" style="max-height: 32px; max-width: 32px; border-radius: 6px;">
            @else
        ...
        <div class="brand-text">
            <div class="brand-name">{{ setting('restaurant_name', 'مطعمنا') }}</div>
        </div>
    </div>
